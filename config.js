...
global.devs = "94760774445" // Developer Contact
global.sudo = process.env.SUDO ? process.env.SUDO.replace(/[\s+]/g, '') : "null";
global.owner= process.env.OWNER_NUMBER ? process.env.OWNER_NUMBER.replace(/[\s+]/g, '') : "94760774445";
...
global.save_status = process.env.AUTO_SAVE_STATUS || "fals"
...
module.exports = {
  ...
  botname : process.env.BOT_NAME  || "wihanga",
  ownername:process.env.OWNER_NAME|| "wihanga",
